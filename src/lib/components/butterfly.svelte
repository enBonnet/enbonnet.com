...
<a
	...
	aria-label={`link to the ${bluesky} bluesky's' account`}
	aria-labelledby={`link to the ${bluesky} bluesky's' account`}
	class="bluesky-flutter self-center pr-2 text-white"
>
	<svg
		id="flutterby"
